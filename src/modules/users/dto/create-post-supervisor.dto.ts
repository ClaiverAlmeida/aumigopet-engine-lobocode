...
import { VALIDATION_MESSAGES, ERROR_MESSAGES } from '../../../shared/common/messages';

export class CreatePostSupervisorDto {
  ...
  // @IsArray({ message: ERROR_MESSAGES.VALIDATION.INVALID_DATA })
